...
class User extends EntityAuditing {
  ...
  @override
  String toString() {
    return 'User{deliveryDetailSite: $deliveryDetailSite, phoneNumber: $phoneNumber, password: $password, name: $name, nickname: $nickname, sex: $sex, birth: $birth, idxFcmToken: $idxFcmToken, userPointRank: $userPointRank, userPoint: $userPoint}';
  }
