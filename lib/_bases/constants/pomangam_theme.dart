...
/// side menu color
final Color sideMenuBackgroundColor = Color.fromRGBO(0x30, 0x30, 0x30, 1.0); // #303030
final Color sideMenuDividerColor = Colors.black.withOpacity(0.1); // Colors.white70;