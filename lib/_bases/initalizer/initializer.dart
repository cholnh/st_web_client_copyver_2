...
import 'package:stwebclientcopyver2/_bases/initalizer/data/cart_data_initializer.dart';
import 'package:stwebclientcopyver2/_bases/initalizer/data/coupon_data_initializer.dart';
import 'package:stwebclientcopyver2/_bases/initalizer/data/delivery_detail_site_data_initializer.dart';
import 'package:stwebclientcopyver2/_bases/initalizer/data/delivery_site_data_initializer.dart';
import 'package:stwebclientcopyver2/_bases/initalizer/data/order_time_data_initializer.dart';
import 'package:stwebclientcopyver2/_bases/initalizer/data/payment_data_initializer.dart';
...
import 'package:stwebclientcopyver2/_bases/network/domain/server_health.dart';
import 'package:stwebclientcopyver2/_bases/network/domain/token.dart';
...
class Initializer {
  ...
  bool isDeliverySiteNotIssuedError;
  ...
  Future initialize({
    ...
    try {
      ...
      isDeliverySiteNotIssuedError = false;
      ...
      if(isAllSuccess()) {
        if(isDeliverySiteNotIssuedError) {
          log('deliverySiteNotIssuedError', name: 'Initializer.initialize', time: DateTime.now());
  ...
  Future<bool> initializeModelData({
    ...
    isServerDown = await initializeNetwork();
    return _initializeModelData(context: context);
  }
  ...
  Future<bool> _initializeModelData({
    ...
    try {
      ...
      if(dIdx == null) {
        isDeliverySiteNotIssuedError = true;
      } else {
        // delivery site
