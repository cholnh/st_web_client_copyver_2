...
void showSignModal({BuildContext context, Widget returnPage, List<String> predicateUrl, Object arguments}) {
      ...
      builder: (context) {
        return SignModal(
          ...
          onSignUp: () {
            ...
            ..predicateUrl = predicateUrl
            ..arguments = arguments;
            Get.to(SignUpPage(), duration: Duration.zero);
