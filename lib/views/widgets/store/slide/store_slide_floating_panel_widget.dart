...
import 'package:stwebclientcopyver2/views/pages/payment/agreement/payment_agreement_page_type.dart';
import 'package:stwebclientcopyver2/views/widgets/store/slide/store_slide_floating_panel_body_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/store/slide/store_slide_floating_panel_footer_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/store/slide/store_slide_floating_panel_header_widget.dart';
...
class StoreSlideFloatingPanelWidget extends StatelessWidget {
  ...
  void _saveOrder(BuildContext context) async {
    ...
    if(isPaymentAgree) {
      ...
      orderModel.changeIsSaving(true);
      ...
      // onSaveOrder();
      paymentModel.goBootpayRequest(context);
    } else {
      Get.to(PaymentAgreementPage(), arguments: PaymentAgreementPageType.FROM_CART, transition: Transition.cupertino, duration: Duration.zero);
    }
  }
}
