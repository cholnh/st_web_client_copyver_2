...
class _SignUpNicknamePageState extends State<SignUpNicknamePage> {
  ...
  void _verify() async {
    try {
      ...
      if(nickname == savedNickname) {
        _routeNext(_model.returnPage, _model.predicateUrl, arguments: _model.arguments);
        //_routeNext(_model.returnPage, arguments: _model.arguments);
        return;
      }
  ...
  void _routeNext(Widget page, List<String> predicateUrl, {Object arguments}) {
    if(page == null) {
