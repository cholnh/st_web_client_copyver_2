...
import 'package:stwebclientcopyver2/domains/user/enum/sex.dart';
import 'package:stwebclientcopyver2/domains/user/enum/sign_view_state.dart';
import 'package:stwebclientcopyver2/providers/sign/sign_up_model.dart';
import 'package:stwebclientcopyver2/views/pages/sign/up/sign_up_authcode_page.dart';
...
import 'package:stwebclientcopyver2/views/widgets/sign/up/sign_up_first_item_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/sign/up/sign_up_second_item_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/sign/up/sign_up_third_item_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/sign/up/sign_up_title_widget.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _routeNext() => Get.to(SignUpAuthCodePage(), transition: Transition.cupertino, duration: Duration.zero);
