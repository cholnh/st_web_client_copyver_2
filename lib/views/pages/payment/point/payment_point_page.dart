...
import 'package:stwebclientcopyver2/domains/user/point_log/point_type.dart';
...
import 'package:stwebclientcopyver2/views/widgets/payment/point/payment_point_add_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/payment/point/payment_point_log_item_widget.dart';
...
class _PaymentPointPageState extends State<PaymentPointPage> {
  ...
  Widget build(BuildContext context) {
    ...
    PaymentPointPageType pageType = Get.arguments ?? PaymentPointPageType.FROM_SETTING;
      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            ...
            Divider(height: 15.0, thickness: 8.0, color: Colors.black.withOpacity(0.03)),
            Expanded(
