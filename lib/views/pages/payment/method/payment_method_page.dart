...
import 'package:stwebclientcopyver2/views/pages/payment/method/payment_method_add_page.dart';
import 'package:stwebclientcopyver2/views/widgets/payment/method/payment_method_add_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/payment/method/payment_method_common_type_widget.dart';
import 'package:stwebclientcopyver2/views/widgets/payment/method/payment_method_user_type_widget.dart';
...
class _PaymentMethodPageState extends State<PaymentMethodPage> {
  ...
  void _onBottomSelected() {
    ...
    ..savePaymentType(this.viewPaymentType, notify: true);
  ...
  void _onAddSelected() {
    ...
    if(isSignIn) {
      ...
      showSignModal(context: context, returnPage: PaymentMethodPage(), predicateUrl: List()..add('/paymentpage')..add('userinfopage'));
    }
  }
}